...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('square-medium', 512, 512, true);
...
// The utility (topmost) navigation
...
// The Support section navigation
function support_nav() {
    wp_nav_menu(
    array(
        'theme_location'  => 'support-menu',
        'container'       => false,
        'menu_class'      => 'nav nav-squares'
        )
    );    
}
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('bootstrap-js', get_template_directory_uri() . '/js/lib/bootstrap.min.js', array('jquery'), false, true);
        wp_enqueue_script('bootstrap-js');

        wp_register_script('bootstrap-tabcollapse', get_template_directory_uri() . '/js/lib/bootstrap-tabcollapse.js', array('jquery', 'bootstrap-js'), false, true);
        wp_enqueue_script('bootstrap-tabcollapse');

        wp_register_script('tweenmax', '//cdnjs.cloudflare.com/ajax/libs/gsap/1.19.1/TweenMax.min.js', array(), false, true );
        wp_enqueue_script('tweenmax'); 

        wp_register_script('main-js', get_template_directory_uri() . '/js/scripts.js', array('jquery', 'bootstrap-js'), false, true);
...
function register_html5_menu()
{
    register_nav_menus(array( 
        ...
        'utility-menu' => __('Utility Menu', 'html5blank'),
        'primary-menu' => __('Primary Menu', 'html5blank'),
        'footer-menu' => __('Footer Menu', 'html5blank'),
        'social-menu' => __('Social Menu', 'html5blank'),
        'support-menu' => __('Support Menu', 'html5blank')
    ));
}
...
function html5blank_styles()
{
    ...
    wp_register_style('engageautism', get_template_directory_uri() . '/style.css', array(), '1.0', 'all');
    wp_enqueue_style('engageautism'); 
